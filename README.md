...
### 📬 2. 텔레그램 그룹에 접속하기 (구독) !
*[Show Corona News 그룹](https://t.me/ShowCoronaNews)* 에 참가해서 매일 오전 11시에 국내 코로나 확진자 수 알림과 매일 11시~19시 사이 1시간마다 네이버 실시간 코로나 뉴스를 주기적으로 받아보세요 :)
